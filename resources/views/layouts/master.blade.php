    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <div class="form-inline ml-3">
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar" v-model="search" type="search" @keyup="searchit" placeholder="Search"
                       aria-label="Search">
...
<script src="{{asset('adminlte/dist/js/demo.js')}}"></script></body>
</html>
